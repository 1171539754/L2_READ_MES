...
class MESClient:
    def __init__(self,BASE_URL,API_KEY,API,data_name,key):
        ...
        self.furnace_collection = self.db.LabResultSlag
...
if __name__ == "__main__":
    mes_client = MESClient("http://10.10.30.57", "XclMesApi/mes-sendTo-L2-LF3", "GetLabResultsSlag", "LabResultSlag", "HeatName")
